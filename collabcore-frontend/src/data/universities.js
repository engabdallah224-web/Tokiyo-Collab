// ~500 Universities from every country in the world (1-2 per country), sorted alphabetically
export const WORLD_UNIVERSITIES = [
  // Afghanistan
  ...
  // Antigua and Barbuda
  "University of the West Indies (Antigua)",
  // Argentina
  ...
  // Saint Lucia
  "University of the West Indies (Saint Lucia)",
  // Samoa
